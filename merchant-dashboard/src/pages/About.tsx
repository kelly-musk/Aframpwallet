  ...
  return (
    <div className="pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-10 rounded-2xl bg-gradient-to-br from-navy-50 to-gold-50 border border-navy-100 text-center">
          ...
          <div className="mt-8 flex justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center px-6 py-3 rounded-xl border border-navy-200 text-navy-700 font-medium hover:bg-navy-50 transition-colors"
            >
