...
const footerLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Stellar Docs', href: 'https://stellar.org' },
      { name: 'Status', href: '#' },
    ],
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              Zero-knowledge privacy layer for Stellar payments. Private, compliant, and built for merchants by Aframp.
            </p>
          </div>
                ...
                {group.links.map((link) => (
                  <li key={link.name}>
                    {link.href.startsWith('http') ? (
                      <a href={link.href} target="_blank" rel="noopener noreferrer" className="text-sm text-gray-500 hover:text-white transition-colors">
                        {link.name}
                      </a>
                    ) : (
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex space-x-6">
            <a href="https://github.com/kelly-musk/Aframpwallet" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-white transition-colors">
